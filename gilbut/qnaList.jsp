...
<jsp:include page="header_login.jsp"/>
	...
	<table class="tb">
		...
		<tbody>
		  ...
		  %>
			  <tr>
			  	<td><%=bean.getId() %></td>
			  	<td><a class="lst" href=""><%=bean.getTitle() %></a></td>
			  	<td><a class="lst" href="" name="content"><%=bean.getContent() %></a></td>
	...
	<div align="center">
		...
		<a href="qnaList2.jsp"><input type="button" value="모두삭제" /></a>
	</div>
